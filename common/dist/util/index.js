...
exports.range = exports.last = exports.plural = exports.count = exports.nameStr = exports.shuffle = exports.MersenneTwister = void 0;
...
exports.count = count;
function plural(num, text, pluralStr) {
    if (!pluralStr) {
        pluralStr = text + "s";
    }
